1. This program is about fizzbuzz which prints all integers between 1 and 99 only if they are multiples of 3, 5 and both, by defining a function and later the function is called at the end. 
